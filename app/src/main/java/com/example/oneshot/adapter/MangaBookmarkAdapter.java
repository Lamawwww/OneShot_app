...
public class MangaBookmarkAdapter extends RecyclerView.Adapter<MangaBookmarkAdapter.MangaViewHolder> {
    ...
    public MangaBookmarkAdapter(Context context, List<Manga> mangaList, OnMangaClickListener onMangaClickListener) {
    ...
    public MangaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_manga_bookmark, parent, false);
